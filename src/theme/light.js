...
function create(palette) {
	...
	return {
		...
		colors: {
			...
			'editorWidget.background': p.whitespace,
			'editorWidget.border': p.whitespace,
			...
			'peekViewEditorGutter.background': p.whitespace,
			'peekViewResult.background': p.whitespace,
			...
			'quickInput.background': p.linenr.bg,
			...
			'sideBarSectionHeader.foreground': p.normal.fg,
			'statusBar.background': p.statuslinenc.bg,
			'statusBar.debuggingBackground': p.whitespace,
			...
			'widget.shadow': p.statuslinenc.bg,
		},
		tokenColors: [
			{
				scope: 'comment',
