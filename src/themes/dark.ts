...
export function create(palette: VscodePalette): VscodeTheme {
	...
	return {
		...
		colors: {
			...
			'editorActionList.background': p.floating.bg,
			'editorActionList.focusBackground': p.floating.list.selection.bg,
			'editorActionList.focusForeground': p.floating.list.selection.fg,
			'editorActionList.foreground': p.editor.fg,
